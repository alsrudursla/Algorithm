...
- i, j == y, x 유의
- 우선순위 큐 기본값 = 오름차순
    - 내림차순 Integer.compare(o2, o1)
- ** 무지개 블록은 다른 색상의 블록 그룹에 속할 수 있다 = 방문 배열 초기화
 */
public class N21609_상어중학교 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(true) {
            pq = new PriorityQueue<>((o1, o2) ->
                // 크기가 가장 큰 블록 그룹 찾기(내림차순) -> 무지개 블록 가장 많은(내림차순) -> 기준 블록 행이 가장 큰(내림차순) -> 열이 가장 큰(내림차순)
